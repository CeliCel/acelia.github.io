...
*/
/*  
a.A value must be entered into each text box.
b.The number of nights must be numeric.
c.The email address must match the pattern provided.
d.Be sure to trim the entries and put them back into the controls regardless ofwhether the entries are valid
*/
